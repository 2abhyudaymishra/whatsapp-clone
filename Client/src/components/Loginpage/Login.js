		...
		<div className="login">
			<div className="login-container">
				<div className="login-header">
					...
					<div className="login-header-title">WhatsApp Web</div>
				</div>
				<div className="login-window">
					<div className="login-window-details">
						<div className="login-window-details-header">
							Use WhatsApp on your computer
						</div>
						<div className="login-window-details-body">
							<ol>
					...
					<div className="login-window-option">
					<div className="login-window-bg"></div>
